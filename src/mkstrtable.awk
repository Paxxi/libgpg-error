...
#
# The variable nspace can be used to prepend a string to each
  ...
  if ($1 ~ /^[0123456789]+$/)
    {
      ...
      print "";
      print "static const char " nspace "msgstr[] = ";
      header = 0;
    }
  else
    print;
...
END {
  ...
  print "";
  print "static const int " nspace "msgidx[] =";
  print "  {";
  ...
  print nspace "msgidxof (int code)";
  print "{";
  print "  return (0 ? 0";
